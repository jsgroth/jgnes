...
| mmc3_test_2/2-details.nes | ❌ | #2: Counter isn't working when reloaded with 255 |
| mmc3_test_2/3-A12_clocking.nes | ❌ | #4: Should be clocked when A12 changes to 1 via PPUADDR write |
| mmc3_test_2/4-scanline_timing.nes | ❌ | #14: IRQ never occurred |
| mmc3_test_2/5-MMC3.nes | ❌ | #2: Should reload and set IRQ every clock when reload is 0 |
